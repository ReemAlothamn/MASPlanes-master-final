...
public class Region {
    ...
    public enum regionState {
        UNASSIGNED, ASSIGNED, EXPLORED, RE_EXPLORED,PENDING, UNEXPLORED
    }
    ...
    private int tasksFound;
     ...
     private int NomOFBlocksassignToPlane=0;
    ...
    public int getNomOFBlocksassignToPlane(){return NomOFBlocksassignToPlane;}
   
    
    public void setNomOFBlocksassignToPlane(int b){NomOFBlocksassignToPlane=b;}
}